...
enum Auxiliary_Security_Header_kimf_enums{ //Key Identifier Mode Field
		ASH_KIMF_TYPE_NO_ADDR = 0,
		ASH_KIMF_TYPE_MACDEF = 1,
		ASH_KIMF_TYPE_4OCTKEY = 2,
		ASH_KIMF_TYPE_8OCTKEY = 3,
};
...
void authLengthChecking(uint8_t securityLevel); //it determines the length of the Authentication field(not in standard)
